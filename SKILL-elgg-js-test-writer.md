...
description: >
  Use when writing JavaScript tests for Elgg plugins. Sets up Vitest for
  testing ES modules (.mjs) and AMD modules. Covers unit tests for JS logic,
  integration tests for Elgg hooks/ajax, and Playwright for UI behavior.
  Adapts to the target Elgg version's JS module system.
category: process
triggers:
  - elgg js test
  - elgg javascript test
  - write js tests elgg
  - test elgg javascript
user-invocable: true
---
