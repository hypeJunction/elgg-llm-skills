...
use ElggMigrate\Rules\V3ToV4\RemovedJsDeps;
use PHPUnit\Framework\TestCase;

final class RemovedJsDepsTest extends TestCase
{
    private RemovedJsDeps $rule;

    protected function setUp(): void
    {
        $this->rule = new RemovedJsDeps();
    }

    public function testAnalyzeFindsRemovedDeps(): void
    {
        $dir = __DIR__ . '/../../fixtures/3x-to-4x/removed-js-deps/input';
        $analysis = $this->rule->analyze($dir);

        $this->assertTrue($analysis->applicable);
        // jquery-treeview, jquery-form, widgets.init( = 3
    ...
    public function testApplyProducesWarningsButNoFileChanges(): void
    {
        ...
        copy(
            __DIR__ . '/../../fixtures/3x-to-4x/removed-js-deps/input/views/default/myplugin/legacy.js',
            $jsDir . '/legacy.js',
        );
    ...
    public function testCleanJsFileIsNotFlagged(): void
    {
        $workDir = sys_get_temp_dir() . '/elgg-migrate-' . uniqid();
        mkdir($workDir, 0755, true);
        file_put_contents($workDir . '/clean.js', "define(['jquery', 'elgg/Ajax'], function(\$, Ajax) {});\n");
