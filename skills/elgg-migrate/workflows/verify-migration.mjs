export const meta = {
  name: 'bodyology-7x-migration-verification',
  description: 'Mine the beads+wolf failure history into the elgg-migrate skill as early tests, enforce tests-first, then fan out agents to author unit/integration/e2e + regression tests proving the bodyology 2x->7x migration is complete at every level, route and account type',
  phases: [
