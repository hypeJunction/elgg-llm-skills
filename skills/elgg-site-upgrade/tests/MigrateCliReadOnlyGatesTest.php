...
final class MigrateCliReadOnlyGatesTest extends TestCase
{
    ...
    public function testVerifyIsReadOnly(): void
    {
        ...
        $this->runCli('--verify --no-guard --no-tests');
    ...
    {
        $before = $this->treeHash();
        $this->runCli('--verify --security --audit --no-guard --no-tests');
    ...
    {
        $before = $this->treeHash();
        $this->runCli('--dry-run --verify --no-guard');
    ...
    {
        $before = $this->treeHash();
        $this->runCli('--apply --verify --no-guard --no-tests');
    ...
    public function testVerifyStillPropagatesGateExitCode(): void
    {
        ...
        $before = $this->treeHash();
        [$code] = $this->runCli('--verify --no-guard --no-tests');
